...
This means one can have an always-on Transendd instance running, and another local Transendd/Transend-qt instance which connects to this node and receives blocks from it.
