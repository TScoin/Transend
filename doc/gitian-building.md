...
*Setup instructions for a gitian build of Solaris using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Solaris
...
To build Solaris (for Linux, OSX and Windows) just follow the steps under 'perform
