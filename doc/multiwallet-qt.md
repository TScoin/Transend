...
In order to support loading of multiple wallets in solaris-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is solaris.cpp.
...
Changes to solaris.cpp
----------------------
solaris.cpp is the entry point into solaris-qt, and as such, will require some minor modifications to provide hooks for
