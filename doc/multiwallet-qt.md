...
In order to support loading of multiple wallets in Transend-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Transend.cpp.
...
Changes to Transend.cpp
----------------------
Transend.cpp is the entry point into Transend-qt, and as such, will require some minor modifications to provide hooks for
