...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 30 * COIN;
    } else if (nHeight <= 10001 && nHeight > 10000) {
        nSubsidy = 1000 * COIN;
    } else if (nHeight <= 14999 && nHeight > 10001) {
        nSubsidy = 30 * COIN;
    } else if (nHeight <= 15000 && nHeight > 14999) {
        nSubsidy = 1000 * COIN;
    } else if (nHeight <= 19999 && nHeight > 15000) {
        nSubsidy = 30 * COIN;
    } else if (nHeight <= 20000 && nHeight > 19999) {
        nSubsidy = 1000 * COIN;
        ...
        nSubsidy = 30 * COIN;
    } else if (nHeight <= 66000 && nHeight >= 33001) {
        nSubsidy = 40 * COIN;
    } else if (nHeight <= 130000 && nHeight >= 66001) {
          nSubsidy = 30 * COIN;
    } else {
        nSubsidy = 25 * COIN;
    }
