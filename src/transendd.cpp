 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Transend (http://www.transendcoin.com),
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        ...
        if (mapArgs.count("-version")) {
            ...
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  transendd [options]                     " + _("Start Pivx Core Daemon") + "\n";
    ...
    try {
        ...
        if (fDaemon) {
            fprintf(stdout, "Transend server starting\n");
