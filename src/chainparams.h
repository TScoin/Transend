...
// Copyright (c) 2015-2017 The Transend Core developers
 ...
 * Transend system. There are three: the main network on which people trade goods
...
public:
    ...
    std::string HodgepodgePoolDummyAddress() const { return strHodgepodgePoolDummyAddress; }
...
protected:
    ...
    std::string strHodgepodgePoolDummyAddress;
