...
// Copyright (c) 2016-2017 The Transend developers
...
// Transend: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // Transend: add to spork database.
