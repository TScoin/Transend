...
QT_MOC_LITERAL(6, 86, 30), // "anonymizeTransendAmountChanged"
QT_MOC_LITERAL(7, 117, 26) // "coinControlFeaturesChanged"
    ...
    "anonymizeTransendAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->anonymizeTransendAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeTransendAmountChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void OptionsModel::anonymizeTransendAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
