                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Hodgepodge Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::HodgepodgeMakeCollaterals));
    typeWidget->addItem(tr("Hodgepodge Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::HodgepodgeCreateDenominations));
    typeWidget->addItem(tr("Hodgepodge Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::HodgepodgeDenominate));
    typeWidget->addItem(tr("Hodgepodge Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::HodgepodgeCollateralPayment));
    ...
    typeWidget->addItem(tr("Received TSC from zTSC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTSC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTSC));
