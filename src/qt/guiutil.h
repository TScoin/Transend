...
/** Utility functions used by the Transend Qt UI.
 */
namespace GUIUtil
{
...
// Render Transend addresses in monospace font
...
// Parse "transend:" URI into recipient object, return true on successful parsing
