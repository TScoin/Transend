...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 TSC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 TSC"));
        ...
        checkzTSC = new QCheckBox(SendCoinsDialog);
        checkzTSC->setObjectName(QStringLiteral("checkzTSC"));
        checkzTSC->setEnabled(false);

        horizontalLayout_2->addWidget(checkzTSC);
        ...
        labelBalance->setText(QStringLiteral("123.456 TSC"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 TSC", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uTSCs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uTSCs in fee,<br />while \"at least\" pays 1000 uTSCs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uTSCs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uTSCs in fee,<br />while \"total at least\" pays 1000 uTSCs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Transend transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for Transend transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzTSC->setText(QApplication::translate("SendCoinsDialog", "Anonymized TSC", Q_NULLPTR));
