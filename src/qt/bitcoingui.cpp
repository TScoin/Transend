                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Transend Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Transend address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Transend: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTSC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Transend Core"), this);
    aboutAction->setStatusTip(tr("Show information about Transend Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Transend"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Transend addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Transend addresses"));
    ...
    openAction->setStatusTip(tr("Open a Transend: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Transend Core help message to get a list with possible Transend command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Transend Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Transend network", "", count));
}
...
{
    QString strTitle = tr("Transend Core"); // default title
