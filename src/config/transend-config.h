/* src/config/transend-config.h.  Generated from transend-config.h.in by configure.  */
/* src/config/transend-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "Transend Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Transend Core 2.0.0"
