Contributing to Transend Core
============================

The Transend Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Transend Core project, and is not to be
confused with overall Transend Network Protocol consensus changes.

Whether a pull request is merged into Transend Core rests with the project merge
...
Patches that change Transend consensus rules are considerably more involved than
...
Where a patch set proposes to change the Transend consensus, it must have been
...
The project leader is the release manager for each Transend Core release.
